<?php  return array (
  ...
  'combo_forceselection_desc' => 'Если включено автозаполнение и если выбрано «Да», то будет разрешен ввод элементов только из списка.',
  ...
  'combo_typeahead_delay_desc' => 'Задержка в миллисекундах перед автозавершением набираемого значения, если автозавершение включено (по умолчанию 250).',
  'date' => 'Дата',
  ...
  'required_desc' => 'Если выбрано «Нет», MODX не разрешит пользователю сохранить ресурс пока это поле не будет заполнено.',
  ...
  'resourcelist_parents_desc' => 'Список ID ресурсов, дочерние ресурсы которых будут в списке.',
  ...
  'hide_time' => 'Скрыть выбор времени',
  'title' => 'Заголовок',
